...
> I build practical software across AI workflows, offline-first iOS products, and developer tools.

## Current Projects
- [docwarp](https://github.com/N10ELabs/docwarp) Rust CLI for Markdown <-> DOCX conversion
